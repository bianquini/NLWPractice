...
const CreatePoint = () => {
  ...
  const [inicialPos, setInicialPos] = useState<[number, number]>([0, 0]);
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(position => {
      ...
      setInicialPos([latitude, longitude]);
    })
  }, [])
    ...
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <Map center={inicialPos} zoom={15} onClick={handleMapClick}>
            <TileLayer
